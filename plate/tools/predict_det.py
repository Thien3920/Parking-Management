...
class TextDetector():
    def __init__(self):
        ...
        self.ort_session = onnxruntime.InferenceSession("/media/thien/DATA/Plate/plate/models/ocr_det.onnx",providers=['CUDAExecutionProvider','TensorrtExecutionProvider', 'CPUExecutionProvider']) #providers=['CUDAExecutionProvider','TensorrtExecutionProvider', 'CPUExecutionProvider']
